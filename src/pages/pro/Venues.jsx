      ...
      <div style={{ display: "flex", gap: 8 }}>
        <input
          ...
          style={{
            ...
            borderRadius: 8, fontSize: 13, background: C.card, color: C.text,
            outline: "none",
          }}
        />
        <select
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                <div style={{ flex: 1, marginRight: 8 }}>
                  ...
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                    ...
                    {v.district && (
                      <span style={{ fontSize: 11, color: C.muted }}>📍 {v.district}</span>
                    )}
                  </div>
                </div>
                <Btn
                ...
                <div style={{
                  ...
                  {v.contact_phone && (
                    <a href={`tel:${v.contact_phone}`}
                      style={{ color: C.brand, marginLeft: "auto", fontWeight: 700 }}>
                      📞 {v.contact_phone}
                    </a>
                  )}
                </div>
