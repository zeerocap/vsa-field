...
export function Modal({ open, onClose, title, children }) {
  ...
  // Escape to close, and keep Tab inside the dialog. This is the PRO app's main
  // interaction surface and previously had neither — the only way out was the
  // backdrop or the × glyph.
  useEffect(() => {
    if (!open) return;
    const onKey = (e) => {
      if (e.key === "Escape") {
