...
export default function Layout({ children }) {
            ...
            {ADMIN_NAV.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {!collapsed && (
                    <span
                      style={{ fontSize: 13, fontWeight: active ? 600 : 500, whiteSpace: "nowrap" }}
                    >
                      {item.label}
                    </span>
                  )}
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, paddingBottom: 68 }}>
      {/* Top bar — flat white to match the canonical topbar (CRM/HRMS), not a
          brand-coloured bar with a glow shadow. */}
      <div
        style={{
          background: C.card,
          padding: "10px 16px",
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: "none",
            fontFamily: "inherit",
            color: isMore || moreOpen ? C.brand : C.faint,
            transition: "color .15s",
            position: "relative",
          }}
        >
